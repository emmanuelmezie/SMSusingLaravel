                 ...
                 <div class="col-md-6">
                    <div class="panel panel-primary">
                      <div class="panel-heading"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Sub Schools
                         ...
                         <a href="/subschools/create/{{ $school->id}}" class="pull-right btn btn-default btn-sm">Add Sub Schools</a> 
                      </div>
                      <div class="panel-body">
                        <ul class="list-group">
                        
                          @foreach($school->subschools as $subschool)
                          <li class="list-group-item">
                            <a href="/subschools/{{$subschool->id}}">{{ $subschool->name }}</a>
                          </li>  
                          @endforeach
